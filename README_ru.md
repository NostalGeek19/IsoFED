...
- С помощью лаунчера вы можете сгенерировать случайный сид мира или ввести свой собственный, чтобы сгенерировать и запустить мир.
...
- Блок воды и лавы теперь может распространяться!
